...
proc create_ipi_design { offsetfile design_name } {
	...
	# Copy all address to GrayScale_Accel_pipe_v3_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/GrayScale_Accel_pipe_v3_0_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/GrayScale_Accel_pipe_v3_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "GrayScale_Accel_pipe_v3_0_hw_${i}"
