...
HD_PWD='/home/silvio/Pynq/Ultra96/grayscale-accel/Vivado Project/GrayScale.runs/design_1_GrayScale_Accel_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_GrayScale_Accel_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_GrayScale_Accel_1_0.tcl
