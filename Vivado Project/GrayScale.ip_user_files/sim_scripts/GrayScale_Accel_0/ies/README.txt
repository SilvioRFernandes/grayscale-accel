...
#
# Generated by export_simulation on Tue May 26 21:35:59 -03 2020
#
################################################################################
...
'-reset_run' switch to the './GrayScale_Accel_0.sh' script.

./GrayScale_Accel_0.sh -reset_run
...
./GrayScale_Accel_0.sh -noclean_files

For more information on the script, please type './GrayScale_Accel_0.sh -help'.
