...
proc create_root_design { parentCell } {
  ...
  # Create instance: GrayScale_Accel_pipe_1, and set properties
  set GrayScale_Accel_pipe_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:GrayScale_Accel_pipe:3.0 GrayScale_Accel_pipe_1 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXIS_TDATA_WIDTH {24} \
   CONFIG.C_S00_AXIS_TDATA_WIDTH {24} \
 ] $GrayScale_Accel_pipe_1
  ...
  connect_bd_intf_net -intf_net GrayScale_Accel_pipe_1_M00_AXIS [get_bd_intf_pins GrayScale_Accel_pipe_1/M00_AXIS] [get_bd_intf_pins axis_dwidth_converter_1/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins GrayScale_Accel_pipe_1/S00_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins GrayScale_Accel_pipe_1/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins GrayScale_Accel_pipe_1/m00_axis_aresetn] [get_bd_pins GrayScale_Accel_pipe_1/s00_axi_aresetn] [get_bd_pins GrayScale_Accel_pipe_1/s00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins GrayScale_Accel_pipe_1/m00_axis_aclk] [get_bd_pins GrayScale_Accel_pipe_1/s00_axi_aclk] [get_bd_pins GrayScale_Accel_pipe_1/s00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs GrayScale_Accel_pipe_1/S00_AXI/S00_AXI_reg] SEG_GrayScale_Accel_pipe_1_S00_AXI_reg
